...
app = tk.Tk()
app.title("Caesar Cipher Encryption/Decryption")

input_label = tk.Label(app, text="Ketik Plaintext atau Chipertextnya:")
input_label.pack()
...
encrypt_button = tk.Button(app, text="Encode Caesar Chiper ", command=encrypt)
encrypt_button.pack()

decrypt_button = tk.Button(app, text="Decode Caesar Chiper", command=decrypt)
decrypt_button.pack()
